...
// Add By ONE
      ...
      $(document).on("click", ".adding" , function(){
        ...
        var shipping_fee = $(this).parent().parent().find('.shipping_fee').val();
        ...
        if(stck != ""){
          ...
          $("#qty"+itemid).html(qty);
            ...
            $.ajax({
                    ...
                    data:{id:pid, itemid:itemid, size_qty:size_qty, size_price:size_price, shipping_fee:shipping_fee},
                    success:function(data){
                        if(data == 0){}
                        else{
        ...
        if(qty < 1){
          ...
          $("#qty"+itemid).html(qty);
            $.ajax({
                    ...
                    data:{id:pid,itemid:itemid,size_qty:size_qty,shipping_fee:shipping_fee,size_price:size_price},
                    success:function(data){
                        $(".discount").html($("#d-val").val());
                        $(".cart-total").html(data[0]);
                        $(".main-total").html(data[3]);
