...
@if(Auth::guard('admin')->user()->sectionCheck('logistics'))

    <li>
        <a href="#logistics" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-truck"></i>{{ __('Logistics') }}
        </a>
        <ul class="collapse list-unstyled" id="logistics" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-logistics-index') }}"><span> {{ __('Manage Company') }}</span></a>
            </li>
            <li>
