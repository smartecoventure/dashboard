    ...
    <!-- Logistics  -->
    <li>
        <a href="#logistics" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-truck"></i>{{ __('Logistics') }}</a>
        <ul class="collapse list-unstyled" id="logistics" data-parent="#accordion" >
            <li>
                <a href="{{ route('admin-logistics-index') }}"> {{ __('Manage Company') }}</a>
            </li>
            <li>
                <a href="{{ route('admin-packaging-center-index') }}"> {{ __('Fulfilment Center') }}</a>
            </li>
            <!-- <li>
                <a href="{{-- route('admin-ready-for-packaging-index') --}}"> {{ __('Ready for Packaging') }}</a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('admin-logistics-withdraw-index') }}"><span>{{ __('Withdraws') }}</span></a>
            </li>
        </ul>
    </li>
    <!-- Vendor  -->
