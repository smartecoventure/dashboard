                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select name="status" required="">
                                ...
                                <!-- <option value="ready for pick up" {{-- $data->status == "ready for pick up" ? "selected":"" --}}>{{ __('Ready for Pick Up') }}</option>
                                <option value="pick up for packaging" {{-- $data->status == "pick up for packaging" ? "selected":""  --}}>{{ __('Pick Up for Packaging') }}</option>
                                <option value="packaging" {{-- $data->status == "packaging" ? "selected":""  --}}>{{ __('Fulfilment Center') }}</option> -->
                                <option value="ready for delivery" {{ $data->status == "ready for delivery" ? "selected":"" }}>{{ __('Ready for Delivery') }}</option>
