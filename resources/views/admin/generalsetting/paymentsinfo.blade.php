                        ...
                        <div class="row justify-content-center">
                          ...
                          <hr>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="action-list">
                                        <select class="process select droplinks {{ $gs->is_flutterwave == 1 ? 'drop-success' : 'drop-danger' }}">
                                          <option data-val="1" value="{{route('admin-gs-flutterwave',1)}}" {{ $gs->is_flutterwave == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                          <option data-val="0" value="{{route('admin-gs-flutterwave',0)}}" {{ $gs->is_flutterwave == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                        </select>
                                      </div>
                                </div>
                              </div>
                            ...
                            <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                    <h4 class="heading">{{ __('FlutterWave Public Key') }} *
                                      </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <input type="text" class="input-field" placeholder="{{ __('FlutterWave Public Key') }}" name="flutterwave_public" value="{{ $gs->flutterwave_public }}" required="">
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                    <h4 class="heading">{{ __('FlutterWave Secret Key') }} *
                                      </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <input type="text" class="input-field" placeholder="{{ __('FlutterWave Secret Key') }}" name="flutterwave_private" value="{{ $gs->flutterwave_private }}" required="">
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                    <h4 class="heading">{{ __('FlutterWave Hash') }} *
                                      </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <input type="text" class="input-field" placeholder="{{ __('FlutterWave Hash') }}" name="flutterwave_hash" value="{{ $gs->flutterwave_hash }}" required="">
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                    <h4 class="heading">{{ __('FlutterWave Text') }} *</h4>

                                </div>
                              </div>
                              <div class="col-lg-6">
                                <textarea class="input-field" name="flutterwave_text" placeholder="{{ __('FlutterWave Text') }}">{{ $gs->flutterwave_text }}</textarea>
