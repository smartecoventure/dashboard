...
@section('content')
                        ...
                        @include('includes.admin.form-error') 
											<form id="geniusformdata" action="{{ route('admin-logistics-store') }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}

						                        <div class="row">
						                          <div class="col-lg-4">
						                            <div class="left-area">
						                                <h4 class="heading">{{ __('Company Profile Image') }} *</h4>
						                            </div>
						                          </div>
						                          <div class="col-lg-7">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="company" placeholder="{{ __("Company Name") }}" required="" value="">
													</div>
												</div>
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <button class="addProductSubmit-btn" type="submit">{{ __("Add Company") }}</button>
						                          </div>
						                        </div>
