...
@section('content')
                        ...
                        @include('includes.admin.form-error') 
											<form id="geniusformdata" action="{{ route('admin-packaging-center-update',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="center" placeholder="{{ __("Center") }}" required="" value="{{ $data->center }}">
													</div>
												</div>
