...
@endif
						...
						<div class="left-content">
							<div class="list">
								...
								<span>{{ Session::has('currency') ?   DB::table('currencies')->where('id','=',Session::get('currency'))->first()->sign   : DB::table('currencies')->where('is_default','=',1)->first()->sign }}</span>
									...
									@if($gs->is_pricetype == 1)
									<!--<li>-->
									<!--	<div class="currency-selector">-->
								 <!--       <span><i class="fas fa-shopping-cart"></i></span>-->
									<!--	<select name="currency" class="currency selectors nice">-->
									<!--	@foreach(DB::table('price_types')->get() as $price)-->
									<!--		<option value="{{route('front.price',$price->id)}}" {{ Session::has('price') ? ( Session::get('price') == $price->id ? 'selected' : '' ) : (DB::table('price_types')->where('is_default','=',1)->first()->id == $price->id ? 'selected' : '') }} >{{$price->name}}</option>-->
									<!--	@endforeach-->
									<!--	</select>-->
									<!--	</div>-->
									<!--</li>-->
	...
	<section class="logo-header" style="background-color:#fff;">
		<div class="container-fluid">
			<div class="row ">
						...
						<div class="search-box">
							<div class="categori-container" id="catSelectForm">
								<select name="category" id="category_select" class="categoris">
									<option style="background-color:#fff;" value="">{{ $langg->lang1 }}</option>
									@foreach($categories as $data)
										<option style="background-color:#fff;" value="{{ $data->slug }}" {{ Request::route('category') == $data->slug ? 'selected' : '' }}>{{ $data->name }}</option>
									@endforeach
								</select>
							</div>
						...
						<div class="categories_menu_inner">
							<ul>
								...
								@endif
									...
									@endphp
									<ul style="max-height:250px; overflow:auto;" class="{{ $ck == 1 ? 'categories_mega_menu' : 'categories_mega_menu column_1' }}">
										@foreach($category->subs as $subcat)
											<li>
...
@yield('content')
	...
	<!-- Footer Area Start -->
	<footer class="footer" id="footer" style="background-color:#333;">
		<div class="container">
			<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
							<div class="content">
								<div class="content">
									<p style="color:#333;">{!! $gs->copyright !!}</p>
							</div>
						</div>
					</div>
				</div>
                    ...
                    <div class="login-form signup-form">
                       @include('includes.admin.form-login')
                        <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                          ...
                          <div class="col-lg-6">
                                <span style="font-size:0.8rem;">Full Name</span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Full Name" type="text" class="User Name" name="name" placeholder="Name" required="">
                                    <i class="icofont-user-alt-5"></i>
                                </div>
                           </div>

                           <div class="col-lg-6">
                                <span style="font-size:0.8rem;">Business Email Address</span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Business Email Address" type="email" class="User Name" name="email" placeholder="Email" required="">
                                    <i class="icofont-email"></i>
                                </div>
                            </div>
                            
                           <div class="col-lg-6">
                                <span style="font-size:0.8rem;">Tel N<u>o</u></span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Tel No" type="text" class="User Name" name="phone" placeholder="{{ $langg->lang184 }}" required="">
                                    <i class="icofont-phone"></i>
                                </div>
                           	</div>
                           <div class="col-lg-6">
                                <span style="font-size:0.8rem;">Business Address</span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Business Address" type="text" class="User Name" name="address" placeholder="{{ $langg->lang185 }}" required="">
                                    <i class="icofont-location-pin"></i>
                                </div>
                           	</div>

                           <div class="col-lg-6">
                                <span style="font-size:0.8rem;">Business Name</span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Business Name" type="text" class="User Name" name="shop_name" placeholder="Store Name" required="">
                                    <i class="icofont-cart-alt"></i>
                                </div>
                           	</div>
                           	
                           <div class="col-lg-6">
                                <span style="font-size:0.8rem;">Business Owner</span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Business Owner" type="text" class="User Name" name="owner_name" placeholder="{{ $langg->lang239 }}" required="">
                                    <i class="icofont-cart"></i>
                                </div>
                           	</div>
                           <!--<div class="col-lg-6">-->
                           ...
                           <!--	</div>-->
                            <div class="col-lg-12">
                                <span style="font-size:0.8rem;">Customer Welcome Message</span>
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="What Customer sees when viewing your store" type="text" class="User Name" name="shop_message" placeholder="{{ $langg->lang243 }}" required="">
                                    <i class="icofont-envelope"></i>
                                </div>
                           	</div>
                            <div class="col-lg-6">
                                <div class="form-input">
                                    <input data-toggle="tooltip" title="Must be Alpha Numeric" type="password" class="Password" name="password" placeholder="{{ $langg->lang186 }}" required="">
                                    <i class="icofont-ui-password"></i>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
 								<div class="form-input">
                                    <input data-toggle="tooltip" title="Confirm Password" type="password" class="Password" name="password_confirmation" placeholder="{{ $langg->lang187 }}" required="">
                                    <i class="icofont-ui-password"></i>
                            	</div>
                           	</div>
                            ...
                            @if($gs->is_capcha == 1)
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-input">
                                        <input data-toggle="tooltip" title="Enter Captcha Code" type="text" class="Password" name="codes" placeholder="{{ $langg->lang51 }}" required="">
                                        <i class="icofont-refresh"></i>
                                    </div>
                                </div>
