...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $feature_products =  Product::where('featured','=',1)->where('status','=',1)->select($selectable)->orderBy('id','desc')->take(6)->get();
        $nav_category =  Category::where('status','=',1)->orderBy('name','asc')->take(7)->get();
        return view('front.index',compact('nav_category','ps','sliders','top_small_banners','feature_products'));
	}
